...
define( 'USERS_FORM_POST', $_ENV['BASE_URL'].'users/form_post/' );
define( 'LOGIN_POST', $_ENV['BASE_URL'].'login/login_post/' );
define( 'SIGNUP_POST', $_ENV['BASE_URL'].'login/signup_post/' );
